...
module.exports = class Block {
     ...
     * 
     * @param {number} block_id - The unique ID assigned by <CONTROLLER>. 
     * @param {number} schedule_id - The ID of the schedule this block is in.
     * @param {number} room_id - The ID of the room this block is held in.
     * @param {number} activity_id - The ID of the activity this block is hosting.
