...
module.exports = class Group {
     ...
     * Create a new group.
     * 
     * @param {number} group_id - The unique ID assigned by <CONTROLLER>.
     * @param {number} schedule_id - The ID of the schedule of this group.
     ...
     * @param {number} camp_id - The ID of the camp this group belongs to.
     */
     ...
     * 
     * @param {number} newStudentID - student id to be added.
     */
     ...
     * 
     * @param {number} newCounselorID - counselor id to be added.
     */
